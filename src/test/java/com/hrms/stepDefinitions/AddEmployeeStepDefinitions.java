...
public class AddEmployeeStepDefinitions extends CommonMethods {
	...
	public void enter_first_and_last_name() {
		sendText(addEmp.firstNameTxtBox, "John");
		sendText(addEmp.lastNameTxtBox, "Wick");
	...
	@When("enter first name as {string} middel name as {string} last as {string}")
	public void enter_first_name_as_middel_name_as_last_as(String firstName, String middleName, String lastName) {
		sendText(addEmp.firstNameTxtBox, firstName);
		sendText(addEmp.middleNameTxtBox, middleName);
		sendText(addEmp.lastNameTxtBox, lastName);
	...
	public void add_multiple_employees_and_verify_they_are_added(DataTable employees) throws InterruptedException {
		...
		for (Map<String, String> employeeName : employeeNames) {
			...
			sendText(addEmp.middleNameTxtBox, middleName);
			sendText(addEmp.lastNameTxtBox, lastName);
			sendText(addEmp.empIdTxtBox, empID);
	...
	public void add_multiple_employees_from_verify_they_are_added_successfully(String sheetName) throws InterruptedException {
		...
		for (Map<String, String> excelEmpName : excelData) {
			...
			String empID = excelEmpName.get("EmployeeID");
